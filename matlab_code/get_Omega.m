...
function Omega = get_Omega(c_next, gamma, x_grid, q_grid, s_grid, q_bar, y_bar, x_mat, q_mat, P)
...
for is = 1:Np
    for js = 1:Np
        ...
        dU_next = interp2(x_mat, q_mat, c_next(:,:,js), x_next, q_next, 'linear').^(-gam);  % Interpolate to get E U'
